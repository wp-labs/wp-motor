...
pub use group::{
    Basis, ExpectMode, FixedGroup, FlexGroup, GroupExpectSpec, SinkGroupConf, default_batch_size,
...
// Re-export orion_error ErrorOwe so downstream can `use crate::structure::ErrorOwe` for `.owe_*()` helpers.
