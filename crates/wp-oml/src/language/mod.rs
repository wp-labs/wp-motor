...
pub use syntax::{
    ...
    functions::{
        ...
        JsonUnescape, MapTo, MapValue, NowDate, NowHour, NowTime, Nth, OnFail, PIPE_BASE64_DECODE,
        PIPE_BASE64_ENCODE, PIPE_EXTRACT_MAIN_WORD, PIPE_EXTRACT_SUBJECT_OBJECT, PIPE_GET,
        PIPE_HTML_ESCAPE, PIPE_HTML_UNESCAPE, PIPE_INTRANET_IP, PIPE_INTRANET_REPLACE,
