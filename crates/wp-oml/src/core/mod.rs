...
impl AsyncFieldExtractor for PreciseEvaluator {
    async fn extract_one_async(
        ...
        match self {
            ...
            PreciseEvaluator::ObjArray(o) => o.extract_one_async(target, src, dst).await,
    ...
    async fn extract_storage_async(
        ...
        match self {
            ...
            PreciseEvaluator::ObjArray(o) => o.extract_storage_async(target, src, dst).await,
    ...
    async fn extract_more_async(
        ...
        match self {
            ...
            PreciseEvaluator::ObjArray(o) => o.extract_more_async(src, dst, cache).await,
    ...
    fn support_batch_async(&self) -> bool {
        match self {
            ...
            PreciseEvaluator::ObjArray(o) => o.support_batch_async(),
