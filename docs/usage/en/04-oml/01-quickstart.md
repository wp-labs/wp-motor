...
> 
> Please refer to the Chinese version: `docs/10-user/04-oml-new/01-quickstart.md`

---

Get started with OML in 5 minutes and transform your parsed data.
...
```
WPL (Parse) → Structured Data → OML (Transform) → Output
```
