...
picker_fetch_timeout_ms = 300 # Blocking source fetch timeout in milliseconds for each picker round
...
- `picker_fetch_timeout_ms` defaults to `300`; it controls how long a realtime picker waits for one blocking fetch round
